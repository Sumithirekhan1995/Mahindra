...
({
    ...
    {  
        console.log('SendSearchValue:: BroadcastEvent');
       ...
       // var fuelType = this.getSpecificValue(component.get("v.selectedFuelLookUpRecords"));
        var TransmissionType = component.get("v.selectedTransmissionTypeLookUpRecords");
        ...
        var state = this.getSpecificValue(component.get("v.selectedStateLookUpRecords"));
       ...
       // var certified = this.getSpecificValue(component.get("v.selectedCertifiedLookUpRecords"));
        ...
        console.log('Broadcasting EventParams:', eventParams);
        UpdateSearchValues.setParams(eventParams);
